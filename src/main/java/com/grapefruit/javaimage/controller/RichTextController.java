...
public class RichTextController {
    ...
    public String saveMd(@RequestBody Markdown markdown, HttpServletRequest request, HttpServletResponse response) {

        Enumeration<String> headerNames = request.getHeaderNames();

        markdown.setTitle("富文本添加");
    ...
    @PostMapping("/downloadRichText")
    public String downloadRichText(HttpServletRequest request, HttpServletResponse response) {
        Enumeration<String> headerNames = request.getHeaderNames();

        List<Enumeration<String>> enumerations = Arrays.asList(headerNames);
    ...
    public void init() {
        ...
        md.setTitle("富文本添加");
        md.setContent("hahah 1010");
        md.setModifier("grape");
        md.setModifyTime(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss")));
